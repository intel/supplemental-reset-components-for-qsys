...
# qsys scripting (.tcl) file for rad_sys
package require -exact qsys 16.0

create_system {rad_sys}
...
add_instance rad reset_assertion_delay
add_instance prm pll_reset_monitor
add_instance pll altera_pll
add_instance sync_subsystem sync_subsystem
...
set_connection_parameter_value sync_subsystem.master_m0/prm.s0 baseAddress {0x0000}
...
add_connection pll.outclk0 sync_subsystem.cr_clk
...
add_connection prm.lock_success_reset sync_subsystem.cr_reset
